...
public class Library {
	...
	public String lookup(long isbn) {
		...
		for (int i = 0; i < library.size(); i++) {
			...
			LibraryBook book = library.get(i);
	...
	public boolean checkout(long isbn, String holder, int month, int day, int year) {
		...
		//If the book has no current holders it performs checkout and sets a holder and due date
	...
	public boolean checkin(long isbn) {
		...
		//look back later
				...
				//If checking in is performed it checks in and unsets the holder and due date
					return true;
