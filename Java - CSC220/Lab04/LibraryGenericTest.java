...
public class LibraryGenericTest{
  ...
  public static void main(String[] args) {
    ...
    ArrayList<LibraryBookGeneric<String>> lib_list = lib3.getInventoryList(); 
    
    for (int i=0 ; i < lib_list.size() -1; i ++){
    	    	
    	long book1 = lib_list.get(i).getIsbn();
    	long book2 = lib_list.get(i+1).getIsbn();
    	
    	if (book1 > book2){
    		
    		System.err.println("List is not sorted");
    		break;
    	}
